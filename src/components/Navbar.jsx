    ...
    <nav className="navbar">
      ...
      <ul className="navbar-nav">
        {user ? (
          <>
            <li>
              <a href="#" className={currentPage === 'dashboard' ? 'active' : ''}
                onClick={e => { e.preventDefault(); onNavigate('dashboard'); }}>Dashboard</a>
            </li>
            <li>
              <a href="#" className={currentPage === 'league' ? 'active' : ''}
                onClick={e => { e.preventDefault(); onNavigate('league'); }}>League</a>
            </li>
            <li>
              <a href="#" className={currentPage === 'leaderboard' ? 'active' : ''}
          ...
          <>
            <li>
              <a href="#" className={currentPage === 'login' ? 'active' : ''}
                onClick={e => { e.preventDefault(); onNavigate('login'); }}>Login</a>
            </li>
            <li>
              <a href="#" className="btn-nav-auth"
                onClick={e => { e.preventDefault(); onNavigate('signup'); }}>Sign Up</a>
            </li>
          </>
        )}
      </ul>
      ...
      {/* Hidden admin link */}
      <a href="#" style={{ fontSize: 10, color: 'rgba(158,176,158,0.15)', marginLeft: 8, textDecoration: 'none' }}
        onClick={e => { e.preventDefault(); onNavigate('admin'); }} title="">♛</a>
    </nav>
  );
};
